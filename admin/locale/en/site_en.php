...
$home_link1 = "Manual of Mini Cms";
$home_link2 = "Website of the Mini Cms' developer";
$home_tab1 = "Users";
$home_tab2 = "Language";
$home_tab3 = "Pages";
...
$prof_box1_desc .=" <li><b>Manager:</b> It can create, modify and delete pages (if there's a blog also posts and categories).";
$prof_box1_desc .= "It can also manage website's settings, like site name or theme.</li>";
$prof_box1_desc .= "<li><b>Editor:</b> It can only create, modify and delete pages (if there's a blog also posts and categories)</li></ul>";
...
$regpage_use_name = "Use site name";
...
$regpage_desc .= "You can choose if you want to view the visual and upload a different image for the <b>visual image</b> on the top of the page.<br><br>";
$regpage_desc .= "You can choose if you want to view the site name and the site description in the visual.<br><br>";
...
$site_uselogo = "Use logo";
$site_sitelogo = "Site logo";
$site_siteshow = "Show name and description in the website";
$site_footer = "Footer text";
$site_lang = "Site language";
$site_box1_desc = "Choose the Site name and the logo, that will be shown on the top of the pages and in the browser header and the footer text for the bottom of the page.";
$site_box2_title = "Contact information";
$site_email = "Contact email";
$site_label = "Label";
$site_label_ph = "es. Main email";
$site_inbox_ph = "es. info@yoursite.com";
$site_reset = "Reset password email";
...
$site_box2_desc .= "<ul><li><b>Email Address for Contact:</b> these are the email which will receive the messages sent from the contact form (the user will see a dropdown menu with all the email)</li>";
...
$al_setContactSucc = "Contact email updated";
$al_setContactErr = "Contact email not updated";
$al_setMailSucc = "Email address created";
$al_setMailErr = "Email address not created";
$al_mailDelSucc = "Email address deleted";
$al_mailDelErr = "Email address not deleted";
