        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><?=$category_name?></td>
                        ...
                        <td>
                        <a href="index.php?man=catPortfolio&op=edit&idToMod=<?=$row["id"] ?>" class="btn btn-warning btn-icon-split">
                            <span class="icon text-white-50">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-primary" href="core/mngCatPortfolio.php?idToDel=<?=$id?>">Ok</a>
                                </div>
                            </div>
                        </div>
                    </div>
